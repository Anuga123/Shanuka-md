...
console.log("ANUWH-MD Session downloaded ✅")
})})}
...
console.log("Connecting ANUWH-MD...⏳️");
...
console.log('ANUWH-MD Is Installing...🔥 ')
...
console.log('ANUWH-MD connected to whatsapp ✅')

let up = `
╭⊱✫🔮 ANUWH-MD 🔮✫⊱╮
│✫➠ - *📂REPOSITORY NAME:* ANUWH-MD
│✫➠ - *📃DESCRIPTIO N: Made by Cyber Anuwh
│✫➠ - *🛡️OWNER:*Cyber Anuwh*
│✫➠ - *🌐 URL:* https://github.com/Anuga123
╰━━━━━━━━━━━━━━━━━╯

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\nPREFIX: ${prefix}`;
conn.sendMessage(config.BOT_NUMBER + "@s.whatsapp.net", { image: { url: `https://postimg.cc/hhNnXtQ0` }, caption: up })
...
if (config.ANTI_LINK == "true"){
        ...
        if(groupAdmins.includes(sender)) return
            let repoInfo = `📌Link Detected ANUWH-MD📌`;
...
if (config.ANTI_LINK == "true"){
        ...
        if (isMe) return await reply("Link Derect but I cant Delete link")
        if(groupAdmins.includes(sender)) return
            let repoInfo = `📌 *Link Detected by ANUWH-MD* 📌\n⚠️❗ *Anti link on....* ⚠️❗`;
        await conn.sendMessage(from, { text: repoInfo }, { quoted: mek });  
        }}}
...
app.get("/", (req, res) => {
res.send("hey I am alive, ANUWH-MD Is started✅");
});
